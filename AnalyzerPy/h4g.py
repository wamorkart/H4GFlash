...
def main(argv):
   ...
   h_mggPP2 = TH1F("h_mggPP2", "a1 and a2: Mass; M(#gamma#gamma) [GeV];Events", 100, 0, 120) 
   ...
   h_mggPP1pz = TH1F("h_mggPP1pz","a1 pz; p_{z} [GeV];Events",100,-150,150)
   h_mggPP2pz = TH1F("h_mggPP2pz","a1 and a2: p_{z}; p_{z} [GeV];Events",100,-150,150)
