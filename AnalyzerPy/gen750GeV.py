...
def main(argv):
   ...
   h_gen_mggPP2=TH1F("h_gen_mggPP2", "a1 and a2 :Mass; M(#gamma#gamma) [GeV];Events", 100, 0, 120)
   ...
   h_gen_deltam = TH1F("h_gen_deltam","gen a1 and a2 mass difference; #Delta m [GeV];Events",100,-300,300)
   ...
   h_mggPP1pz = TH1F("h_mggPP1pz","a1 pz; p_{z} [GeV];Events",100,-900,900)
   ...
   h_gen_mggPP2pz = TH1F("h_gen_mggPP2pz","a1 and a2: p_{z}; p_{z} [GeV];Events",100,-900,900)
   ...
   h_gen1_eta = TH1F("h_gen1_eta","gen #gamma #eta eta;#eta;Events",100,-2.5,2.5)
   ...
   h_p4_eta = TH1F("h_p4_eta","#eta of photons; #eta(#gamma);Events",100,-2.7,2.7)
   ...
   h_gen_dphi_a2 = TH1F("h_gen_dphi_a2","Delta phi a2;delta phi; Events",100,-4,4)
   h_gen_deta_a1 = TH1F("h_gen_deta_a1","gen a1 and a2 : #Delta #eta; #Delta #eta; Events", 100,-4,4)
   h_gen_deta_a2 = TH1F("h_gen_deta_a2","Delta eta a2;delta eta; Events",100,-4,4)
...
#         print mt.first, mt.second
   ...
   legend = TLegend(0.8,0.8,0.7,0.9)
   ...
   h_gen_mggPP1.SetLineColor(4)
   h_gen_mggPP1.GetYaxis().SetTitleOffset(1.5)
   h_gen_mggPP1.SetLineWidth(2)
   h_gen_mggPP1.Draw()
   h_gen_mggPP2.SetLineColor(8)
   h_gen_mggPP2.SetLineWidth(2)
   h_gen_mggPP2.Draw("same")
   ...
   legend = TLegend(0.75,0.8,0.9,0.9)
   legend.AddEntry(h_gen_dr_a2,"gena2 #Delta r","lp")
   legend.AddEntry(h_gen_dr_a1,"gena1 #Delta r","lp")
   legend.Draw()
   ...
   h_gen_dphi_a1.SetLineColor(4)
   h_gen_dphi_a1.GetYaxis().SetTitleOffset(1.5)
   h_gen_dphi_a1.SetLineWidth(2)
   h_gen_dphi_a1.Draw()
   h_gen_dphi_a2.SetLineColor(8)
   h_gen_dphi_a2.SetLineWidth(2)
   h_gen_dphi_a2.Draw("same")
   ...
   h_gen_deta_a1.SetLineColor(4)
   h_gen_deta_a1.GetYaxis().SetTitleOffset(1.5)
   h_gen_deta_a1.SetLineWidth(2)
   h_gen_deta_a1.Draw()
   h_gen_deta_a2.SetLineColor(8)
   h_gen_deta_a2.SetLineWidth(2)
   h_gen_deta_a2.Draw("same")
